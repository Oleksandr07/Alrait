    ...
    $.fn.airStickyBlock = function(options){
        $.airStickyBlock = function($this, options){
            ...
            function setAmount(){
                ...
                stickyBeforeParentHeight = /*$('header').height() + $('.content_menu .menu_pc').height() + $('.content_menu .block_mobile').height() + 20*/ 40
                ...
                stickyParentOffset = stickyParent.offset().top - stickyBeforeParentHeight;
                ...
                stickyStop = stopBlockHeight + stopBlockOffset - stickyHeight - stickyBeforeParentHeight + 20;
            ...
            function setPosition(position){
                switch (position){
                    case 'fixed':
                        $this.css({
                            'position': position,
                            'top': 0 + stickyBeforeParentHeight
